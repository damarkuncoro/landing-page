import { defineLandingPage, createReactRenderer, createHeaderSection, createHeroSection, createFeaturesSection, createTestimonialsSection, createPricingSection, createCtaSection, createFooterSection, createStatsSection, createFaqSection } from '@damarkuncoro/landing-page'
import type { LandingPageConfig } from '@damarkuncoro/landing-page'

// Define your landing page configuration
const landingPageConfig: LandingPageConfig = defineLandingPage({
